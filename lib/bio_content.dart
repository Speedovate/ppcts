...
const bioNotes = [
  ...
  BioNote("ROBERTO P. ALABADO III", "National and Regional Tourism Overview", [
  ...
  BioNote("ROY RODRIGUEZ", "Best Practice Sharing – Tourist Destination", [
  ...
  BioNote("SENITH O. ARAEZ", "Best Practice Sharing – Tour Operator", [
  ...
  BioNote("MS. LEONORA C. ESCOLLANTE", "Sports Development Tourism", [
    "It is a privilege to introduce a woman whose leadership, vision, and dedication have shaped the course of Philippine paddling and sports tourism.",
    "Ms. Leonora C. Escollante is the President of the Philippine Paddling Federation, an Executive Board Member of the Philippine Olympic Committee, and the Chairperson of the Philippine Olympic Committee on Gender Equality — a role through which she champions inclusivity, empowerment, and equal opportunity in sports.",
  ...
  BioNote("JOVENEE C. SAGUN", "10-Year Tourism Master Plan: Initial Presentation", [
  ...
  BioNote("EARL H. TIMBANCAYA", "Tourism Safety, Preparedness & Risk Management", [
    "Mr. Earl H. Timbancaya is a Disaster Risk Reduction and Management practitioner with over 15 years of experience in the field. He currently serves as the Disaster Risk Reduction and Management Officer of the Puerto Princesa City Disaster Risk Reduction and Management Office. He contributed exceptional dedication to empowering communities with the knowledge and skills necessary to prepare and respond to emergencies and extreme situations accordingly.",
    ...
    "Mr. Timbancaya is also one of the members of the National Pool of CADRES on Incident Command System.",
